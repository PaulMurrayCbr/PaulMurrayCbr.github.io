...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 18, vars: 10, consts: [[1, "container-fluid"], [1, "row"], [1, "col-12"], [1, "btn-group", "col-10"], ["type", "button", 1, "btn", "btn-sm", "btn-outline-primary", 3, "ngClass", "click"], ["type", "button", "class", "btn btn-sm btn-outline-primary", 3, "ngClass", "click", 4, "ngIf"], [1, "btn-group", "col-2"], ["type", "button", 1, "btn", "btn-sm", "btn-dark", 3, "click"], [4, "ngIf"], [1, "btn-group", "col-12"], ["type", "button", 1, "btn", "btn-primary", "col-12", 3, "ngClass", "click"], [1, "col-4"], [1, "btn-group", "col-8"], ["type", "button", 1, "btn", "btn-sm", "btn-outline-primary", "disabled", 3, "ngClass", "click"], [1, "col-2"], ["type", "color", 1, "col-1", 3, "ngModel", "change", "ngModelChange"], ["type", "button", 1, "col-2", "btn", "btn-sm", "btn-outline-primary", 3, "click"], ["name", "interpSelect", 1, "col-8", 3, "ngModel", "change", "ngModelChange"], ["value", "linear"], ["value", "huenear"], ["value", "huefar"], ["value", "huerbow"], ["value", "huexrbow"], ["value", "hueup"], ["value", "huedown"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
